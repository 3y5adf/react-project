...
CREATE TABLE `sns_chatroom` (
  ...
  PRIMARY KEY (`CHATNO`),
  KEY `USERID` (`USERID`),
  CONSTRAINT `sns_chatroom_ibfk_1` FOREIGN KEY (`USERID`) REFERENCES `sns_user` (`USERID`)
...
CREATE TABLE `sns_chatroom_member` (
  ...
  CONSTRAINT `sns_chatroom_member_ibfk_1` FOREIGN KEY (`CHATNO`) REFERENCES `sns_chatroom` (`CHATNO`),
  CONSTRAINT `sns_chatroom_member_ibfk_2` FOREIGN KEY (`USERID`) REFERENCES `sns_user` (`USERID`),
  CONSTRAINT `sns_chatroom_member_ibfk_3` FOREIGN KEY (`LASTREAD`) REFERENCES `sns_chatroom_message` (`MSGNO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sns_chatroom_message` (
  ...
  KEY `CHATNO` (`CHATNO`),
  KEY `USERID` (`USERID`),
  CONSTRAINT `sns_chatroom_message_ibfk_1` FOREIGN KEY (`CHATNO`) REFERENCES `sns_chatroom` (`CHATNO`),
  CONSTRAINT `sns_chatroom_message_ibfk_2` FOREIGN KEY (`USERID`) REFERENCES `sns_user` (`USERID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sns_comment` (
  ...
  CONSTRAINT `sns_comment_ibfk_1` FOREIGN KEY (`USERID`) REFERENCES `sns_user` (`USERID`),
  CONSTRAINT `sns_comment_ibfk_2` FOREIGN KEY (`FEEDNO`) REFERENCES `sns_feed` (`FEEDNO`),
  CONSTRAINT `sns_comment_ibfk_3` FOREIGN KEY (`PRCOMMENTNO`) REFERENCES `sns_comment` (`COMMENTNO`)
...
INSERT INTO `sns_comment` VALUES (1,'admin01',5,'나가','2025-11-27 14:50:50','2025-11-27 14:50:50',NULL),(2,'admin01',4,'어','2025-11-27 14:51:09','2025-11-27 14:51:09',NULL),(3,'admin01',4,'어','2025-11-27 14:52:18','2025-11-27 14:52:18',NULL),(4,'admin01',3,'에휴','2025-11-27 17:11:11','2025-11-27 17:11:11',NULL),(5,'qwer',4,'으멩넴겜ㄴ에','2025-11-27 18:32:10','2025-11-27 18:32:10',2),(6,'qwer',4,'2141243','2025-11-27 18:49:06','2025-11-27 18:49:06',3),(7,'qwer',5,'ㅂㅈㄷㄱ','2025-11-27 18:49:14','2025-11-27 18:49:14',1),(8,'qwer',5,'ㄴㄴ','2025-11-27 18:49:33','2025-11-27 18:49:33',1),(9,'qwer',4,'ㄴㄴ','2025-11-27 18:49:41','2025-11-27 18:49:41',2),(10,'qwer',4,'싷','2025-11-27 18:52:30','2025-11-27 18:52:30',NULL),(11,'qwer',4,'ㄴㄴ','2025-11-27 18:52:40','2025-11-27 18:52:40',NULL),(12,'qwer',4,'ㄴㄴ','2025-11-27 18:55:11','2025-11-27 18:55:11',10),(13,'qwer',4,'ㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁㅁㄴㅇㄻㅁㄴㅇㄹㄴㅁ','2025-11-27 19:06:21','2025-11-27 19:06:21',NULL);
...
CREATE TABLE `sns_feed` (
  ...
  PRIMARY KEY (`FEEDNO`),
  KEY `USERID` (`USERID`),
  CONSTRAINT `sns_feed_ibfk_1` FOREIGN KEY (`USERID`) REFERENCES `sns_user` (`USERID`)
...
INSERT INTO `sns_feed` VALUES (2,'admin01','테스트','테스트1',0,'2025-11-26 18:52:56','2025-11-26 18:52:56','N'),(3,'admin01','엉엉','앙앙',0,'2025-11-26 18:58:19','2025-11-26 18:58:19','F'),(4,'qwer','오','왓',0,'2025-11-26 20:04:36','2025-11-26 20:04:36','F'),(5,'qwer','따흐흑','따흐앙',0,'2025-11-27 11:34:33','2025-11-27 11:34:33','Q');
...
CREATE TABLE `sns_feed_img` (
  ...
  PRIMARY KEY (`IMGNO`),
  KEY `FEEDNO` (`FEEDNO`),
  CONSTRAINT `sns_feed_img_ibfk_1` FOREIGN KEY (`FEEDNO`) REFERENCES `sns_feed` (`FEEDNO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sns_report` (
  ...
  KEY `USERID` (`USERID`),
  CONSTRAINT `sns_report_ibfk_1` FOREIGN KEY (`USERID`) REFERENCES `sns_user` (`USERID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sns_user` VALUES ('admin01','$2b$10$tuOLOTObZOVz8RsqQp82SuEkZwjBsgJxXBCN65AIRLy1QMBvnYSha','관리자','admin01@gmail.com','http://localhost:3020/user/uploads/profile-images/profile01.png','A','2025-11-26 18:03:18','2025-11-26 18:03:18',0),('asdf1234','$2b$10$VlWqIdbgnh7Kiv5qGI9r9.rM/3U3BvaP0LvTPZKc7KEJpqCNiT28u','asdf1234','asdf1234@gmail.com','http://localhost:3020/user/uploads/profile-images/profile10.png','U','2025-11-26 15:43:21','2025-11-26 15:43:21',0),('qwer','$2b$10$eFkiubb8rS3iPkXfn7Gud.ckbnyDAaPcCa6GjwVOZV73U3BAS8Jni','qwer','qwer@gmail.com','http://localhost:3020/user/uploads/profile-images/profile13.png','U','2025-11-26 20:04:23','2025-11-26 20:04:23',0);
...
-- Dump completed on 2025-11-27 20:04:34
